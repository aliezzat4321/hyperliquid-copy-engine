...
| feed polling and direct watch paced by one account-wide Invo token bucket with structural feed priority, adaptive 429 cooldown and an AIMD rate floor | builder-validated at 92092ff on branch fix/lane3-ingestion-rate-budget, not yet opened as a PR, reviewed or CI-run: direct watch can neither consume the configured feed reserve nor overtake a queued feed request, a feed 429 gates reconciliation in full while a direct-watch 429 costs the feed only its configured share, and the direct-watch watchdog bound is taken at the rate floor so an adaptive reduction cannot fire a false stall | `2026-09-24T19:47:10Z` | commit `92092ff9b6b723f7c29240392c4af9483e439286` |
| executor npm run check subtests passing (typecheck clean) | 366 | `2026-09-24T19:47:10Z` | commit `92092ff9b6b723f7c29240392c4af9483e439286` |
| Lane 3 shadow-health validator pytest tests passing | 3 | `2026-09-24T19:47:10Z` | commit `92092ff9b6b723f7c29240392c4af9483e439286` |
| Invo API surfaces pinned to a declared budget class by the enforced call-site inventory test, checked against source in both directions | 8 | `2026-09-24T19:47:10Z` | commit `92092ff9b6b723f7c29240392c4af9483e439286` |
