...
| feed polling and direct watch paced by one account-wide Invo token bucket with structural feed priority, adaptive 429 cooldown and an AIMD rate floor | validated on PR #414 at 17c05bd; implementation tests and CI passed; independent review blocked only on stale provenance: direct watch can neither consume the configured feed reserve nor overtake a queued feed request, a feed 429 gates reconciliation in full while a direct-watch 429 costs the feed only its configured share, the direct-watch watchdog bound is taken at the rate floor so an adaptive reduction cannot fire a false stall, and the internal pump now wakes on a higher-priority arrival so a queued DIRECT_WATCH head can no longer pace a later FEED request at reconciliation's refill rate | `2026-09-25T07:50:00Z` | commit `17c05bde1569b3189c573cea58a547b45a099379` |
| executor npm run check subtests passing (typecheck clean) | 369 | `2026-09-25T07:50:00Z` | commit `17c05bde1569b3189c573cea58a547b45a099379` |
| Lane 3 shadow-health validator pytest tests passing | 3 | `2026-09-25T07:50:00Z` | commit `17c05bde1569b3189c573cea58a547b45a099379` |
| Invo API surfaces pinned to a declared budget class by the enforced call-site inventory test, checked against source in both directions | 8 | `2026-09-25T07:50:00Z` | commit `17c05bde1569b3189c573cea58a547b45a099379` |
