...
def parse_review_profile(body: str, cfg: dict[str, Any], task_class: str) -> str:
    ...
    if not values and acceptance_flag(body, "AI_TEAM_PROTECTED_CHANGE"):
        # Bootstrap migrations retain the trusted pre-v2 independent Claude gate.
        profile = "ENGINE_CRITICAL"
