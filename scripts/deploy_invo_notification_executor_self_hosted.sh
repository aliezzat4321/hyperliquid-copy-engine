...
set_env NOTIFICATION_TRADER_ACCEPTANCE_LATEST_PATH /var/lib/hyperliquid-copy-engine/invo-notification-executor/lane3-runtime-acceptance-latest.json
set_env NOTIFICATION_TRADER_ACCEPTANCE_JOURNAL_PATH /var/lib/hyperliquid-copy-engine/invo-notification-executor/lane3-runtime-acceptance.jsonl
set_env NOTIFICATION_TRADER_ACCEPTANCE_INTERVAL_MS 900000
